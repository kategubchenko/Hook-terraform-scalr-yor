...
export YOR_SIMPLE_TAGS="$(python3 $SCALR_HOOK_DIR/scripts.py get-tags -h $SCALR_HOSTNAME -t $SCALR_TOKEN -r $SCALR_RUN_ID)"
...
./yor tag --tag-groups simple -d $SCALR_HOOK_DIR --skip-tags git*
